...
#include <iostream>
#include <sstream>
#include <tuple> // Para std::get

// Definições dos membros estáticos
// Usando a nova CacheKey
...
void CalibrationCacheManager::forceSaveCache() {
    // Não precisa chamar initialize() aqui, pois saveCacheToFileAtExit não depende de cacheInitialized
    // para a lógica de escrita em si, apenas para a mensagem de log.
